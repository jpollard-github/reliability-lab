...
Incident explanation requires the order and original context of retries, fallbacks, validation, and
budget decisions. Updating a single status document destroys that evidence. Append-only events also
support future projection rebuilding and audit review.
