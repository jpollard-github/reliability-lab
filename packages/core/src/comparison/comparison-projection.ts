...
/**
 * Projects original and variant execution evidence into conservative comparison dimensions.
 * It does not choose a winner, resolve variations, or submit replay executions.
 */
